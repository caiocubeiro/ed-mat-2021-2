...
/*
    Na busca binária, a comparação entre o valor de busca e o valor que está no meio
    do vetor tem três possibilidades:
    ...
    Para usar a busca binária em um VETOR DE OBJETOS, precisamos transferir
    a comparação para uma funlão externa que retorno um dos três valores
    0 -> caso ambos valores sejam IGUAIS
    1 -> caso o valor de busca é MAIOR que o valor do meio do vetor
